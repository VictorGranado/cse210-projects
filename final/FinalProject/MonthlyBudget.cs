...
class MonthlyBudget : FinancialReport
{
    private decimal[] incomeValues;
    private decimal[] expenseValues;

    public MonthlyBudget(decimal[] income, decimal[] expenses)
    {
        incomeValues = income;
    ...
    {
        Console.WriteLine("Monthly Budget Report");
        Console.WriteLine("---------------------");
    ...
    public override void SaveToCSV(string fileName)
    {
        ...
        Console.WriteLine($"Monthly budget report saved to {fileName} successfully.");
    }
    ...
    public override void LoadFromCSV(string fileName)
    {
        if (File.Exists(fileName))
        {
            ...
            Console.WriteLine($"Monthly budget report loaded from {fileName} successfully.");
        }
        else
        {
